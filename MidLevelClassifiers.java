...
public class MidLevelClassifiers 
{
	//Rule: 1v0
	...
	public MidLevelClassifiers()
	{
		
	}
	public static Stacking ConcussionvsCoronaryArtery()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	File[] blackList = new File[3];
    	//Positive
    	whiteList[0] = new File(voiceFile+"ConcussionDataSet.txt");
    	whiteList[1] = new File(voiceFile+"TraumaticBrainInjuryDataSet.txt");
    	//Negative
    	blackList[0] = new File(voiceFile+"CoronaryArteryDataSet.txt");
    	blackList[1] = new File(voiceFile+"HypopharyngealDataSet.txt");
    	blackList[2] = new File(voiceFile+"LaryngealDataSet.txt");
	...
	public static Stacking CoronaryArteryvsCancer()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	//Positive
    	whiteList[0] = new File(voiceFile+"CoronaryArteryDataSet.txt");
    	//Negtive
    	blackList[0] = new File(voiceFile+"HypopharyngealDataSet.txt");
    	blackList[1] = new File(voiceFile+"LaryngealDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);
		String skip2 = tnf2.getName();
		PrintWriter printer = new PrintWriter(new BufferedWriter(new FileWriter(combinedFile)));
	...
	public static Stacking ParkinsonsvsHuntingtons()throws Exception
	{
		/*
		 * Compile Data
		 */
		//Detail file status
    	File[] whiteList = new File[4];
    	File[] blackList = new File[4];
    	//Positive
    	whiteList[0] = new File(voiceFile+"ALSDataSet.txt");
    	whiteList[1] = new File(voiceFile+"CerebralPalsyDataSet.txt");
    	whiteList[2] = new File(voiceFile+"DementiaDataSet.txt");
    	whiteList[3] = new File(voiceFile+"ParkinsonsDataSet.txt");
    	//Negtive
    	blackList[0] = new File(voiceFile+"HuntingtonsDataSet.txt");
    	blackList[1] = new File(voiceFile+"MultipleSclerosisDataSet.txt");
    	blackList[2] = new File(voiceFile+"AlzheimersDataSet.txt");
    	blackList[3] = new File(voiceFile+"MultipleSystemAtrophyDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);
		String skip2 = tnf2.getName();
		PrintWriter printer = new PrintWriter(new BufferedWriter(new FileWriter(combinedFile)));
	...
	public static Stacking ParkinsonsvsDementia()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	whiteList[1] = new File(voiceFile+"ALSDataSet.txt");
    	//Negative
    	blackList[0] = new File(voiceFile+"DementiaDataSet.txt");
    	blackList[1] = new File(voiceFile+"CerebralPalsyDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);
		String skip2 = tnf2.getName();
		PrintWriter printer = new PrintWriter(new BufferedWriter(new FileWriter(combinedFile)));
	...
	public static Stacking HuntingtonsvsMultiple()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	File[] blackList = new File[2];
    	//Positive
    	whiteList[0] = new File(voiceFile+"AlzheimersDataSet.txt");
    	whiteList[1] = new File(voiceFile+"HuntingtonsDataSet.txt");
    	//Negtive
    	blackList[0] = new File(voiceFile+"MultipleSclerosisDataSet.txt");
    	blackList[1] = new File(voiceFile+"MultipleSystemAtrophyDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);
		String skip2 = tnf2.getName();
		PrintWriter printer = new PrintWriter(new BufferedWriter(new FileWriter(combinedFile)));

...
public class ConfirmationClassifiers 
{
	...
	public ConfirmationClassifiers()
	{
		
	}
	public static Stacking ConcussionConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
	...
	public static Stacking TraumaticBrainInjuryConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
	...
	public static Stacking CoronaryArteryConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
	...
	public static Stacking LaryngealCancerConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	File[] blackList = new File[1];
    	//Positive
    	whiteList[0] = new File(voiceFile+"LaryngealCancerDataSet.txt");
    	//Negative
    	blackList[0] = new File(voiceFile+"ControlDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);
	...
	public static Stacking HypopharyngealCancerConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	File[] blackList = new File[1];
    	//Positive
    	whiteList[0] = new File(voiceFile+"HypopharyngealCancerDataSet.txt");
    	//Negative
    	blackList[0] = new File(voiceFile+"ControlDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);
	...
	public static Stacking ParkinsonsConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
	...
	public static Stacking ALSConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
	...
	public static Stacking DementiaConfirm()throws Exception
{
		/*
		 * Compile Data
		 */
	...
	public static Stacking CerebralPalsyConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	File[] blackList = new File[1];
    	//Positive
    	whiteList[0] = new File(voiceFile+"CerebralPalsyDataSet.txt");
    	//Negative
    	blackList[0] = new File(voiceFile+"ControlDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);
	...
	public static Stacking HuntingtonsConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
	...
	public static Stacking AlzheimersConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
	...
	public static Stacking MultipleSclerosisConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
	...
	public static Stacking MultipleSystemAtrophyConfirm()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	File[] blackList = new File[1];
    	//Positive
    	whiteList[0] = new File(voiceFile+"MultipleSystemAtrophyDataSet.txt");
    	//Negative
    	blackList[0] = new File(voiceFile+"ControlDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);

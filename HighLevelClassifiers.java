...
public class HighLevelClassifiers 
{
	//Rule: 1v0
	...
	public HighLevelClassifiers()
	{
		
	}
	public static Stacking PathologyvsControl()throws Exception
	{
		/*
		 * Compile Data
		 */
    	...
    	File[] blackList = new File[12];
    	//Positive
    	whiteList[0] = new File(voiceFile+"ALSDataSet.txt");
    	whiteList[1] = new File(voiceFile+"AlzheimersDataSet.txt");
    	whiteList[2] = new File(voiceFile+"CerebralPalsyDataSet.txt");
    	whiteList[3] = new File(voiceFile+"ConcussionDataSet.txt");
    	whiteList[4] = new File(voiceFile+"CoronaryArteryDataSet.txt");
    	whiteList[5] = new File(voiceFile+"DementiaDataSet.txt");
    	whiteList[5] = new File(voiceFile+"HuntingtonsDataSet.txt");
    	whiteList[6] = new File(voiceFile+"HypopharyngealDataSet.txt");
    	whiteList[7] = new File(voiceFile+"LaryngealDataSet.txt");
    	whiteList[8] = new File(voiceFile+"MultipleSclerosisDataSet.txt");
    	whiteList[9] = new File(voiceFile+"MultipleSystemAtrophyDataSet.txt");
    	whiteList[10] = new File(voiceFile+"ParkinsonsDataSet.txt");
    	whiteList[11] = new File(voiceFile+"TraumaticBrainInjuryDataSet.txt");
    	//Negtive
    	blackList[0] = new File(voiceFile+"ControlDataSet.txt");
	...
	public static Stacking OthervsBasalGanglia()throws Exception
	{
		/*
		 * Compile Data
		 */
		//Detail file status
    	File[] whiteList = new File[5];
    	File[] blackList = new File[8];
    	//Positive
    	whiteList[0] = new File(voiceFile+"TraumaticBrainInjuryDataSet.txt");
    	whiteList[1] = new File(voiceFile+"ConcussionDataSet.txt");
    	whiteList[2] = new File(voiceFile+"CoronaryArteryDataSet.txt");
    	whiteList[3] = new File(voiceFile+"LaryngealDataSet.txt");
    	whiteList[4] = new File(voiceFile+"HypopharyngealDataSet.txt");
    	//Negative
    	blackList[0] = new File(voiceFile+"ALSDataSet.txt");
    	blackList[1] = new File(voiceFile+"AlzheimersDataSet.txt");
        blackList[2] = new File(voiceFile+"CerebralPalsyDataSet.txt");
    	blackList[3] = new File(voiceFile+"DementiaDataSet.txt");
    	blackList[4] = new File(voiceFile+"HuntingtonsDataSet.txt");
    	blackList[5] = new File(voiceFile+"MultipleSclerosisDataSet.txt");
    	blackList[6] = new File(voiceFile+"MultipleSystemAtrophyDataSet.txt");
    	blackList[7] = new File(voiceFile+"ParkinsonsDataSet.txt");
		//Detail which file to send to
		File tnf2 = new File(combinedFile);
		String skip2 = tnf2.getName();
		PrintWriter printer = new PrintWriter(new BufferedWriter(new FileWriter(combinedFile)));
